...
public class TestaCaminho {
    ...
    public static void main(String[] args) {
        Trecho trecho1 = new TrechoAndando("Vá até o cruzamento da Av. Rebouças com a Av. Brigadeiro Faria Lima",
                500);
        Trecho trecho2 = new TrechoDeCarro("Vå até o cruzamento da Av. Brigadeiro Faria Lima com a Av. Cidade Jardim",
                1500);
